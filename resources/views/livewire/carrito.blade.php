                            ...
                            <div
                                ...
                                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    <a href="#" class="shrink-0 md:order-1">
                                        <img src="{{ $imageUrl }}" class="w-12 md:w-16" alt="{{ $item['nombre'] }}">
                                    </a>
                                    ...
                                    <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                        ...
                                        @if ($item['impuestos'] > 0)
                                            <div>
                                                <p class="text-base font-medium text-gray-900 dark:text-white">Impuestos
                                        ...
                                        @if ($item['descuentos'] > 0)
                                            <div>
                                                <p class="text-base font-medium text-gray-900 dark:text-white">Descuentos
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <button type="button" wire:click="eliminarProducto({{ $id }})"
                    ...
                    <div
                        ...
                        <div class="space-y-4">
                            <div class="space-y-2">
                                ...
                                <!-- Descuentos Totales -->
                                <dl class="flex items-center justify-between gap-4">
                                    <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Total Descuentos
                                    </dt>
                                ...
                                <!-- Impuestos Totales -->
                                <dl class="flex items-center justify-between gap-4">
                                    <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Total Impuestos</dt>
                                    <dd class="text-base font-medium text-gray-900 dark:text-white">
