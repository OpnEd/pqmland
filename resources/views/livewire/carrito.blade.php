                ...
                <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                    <div class="space-y-6">
                        @foreach ($carrito as $id => $item)
                            <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:py-6 md:px-16">
                                @php
                                ...
                                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    ...
                                    <div class="flex items-center justify-between md:order-3 md:justify-end">
                                        ...
                                        <div class="text-end md:order-4 md:w-32">
                                            <p class="text-base font-bold text-gray-900 dark:text-white">${{ number_format($item['precio'] * $item['cantidad'], 2) }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                        <div class="flex flex-row gap-3">
                                            ...
                                            <p class="text-base font-bold text-gray-900 dark:text-white">${{ number_format($item['precio']) }} / Und.</p>
                                        </div>
