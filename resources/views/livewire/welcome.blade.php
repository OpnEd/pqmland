<div>
    ...
    {{-- <section class="bg-white dark:bg-gray-900">
        <div x-data="handleScroll()" x-init="init()" @scroll.window="onScroll" class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 transition-all duration-500 transform">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1
                    class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
                    {{ $seccionHero->title }}</h1>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">{{ $seccionHero->subtitle }}</p>
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex shadow-2xl rounded-xl">
                <img src="{{ asset('storage/images/welcome/'.$seccionHero->image.'.png') }}" alt="mockup" class="rounded-xl">
            </div>
        </div>
    </section> --}}
    <section class="bg-white dark:bg-gray-900">
