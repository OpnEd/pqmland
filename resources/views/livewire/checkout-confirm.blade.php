    ...
    <form action="#" class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
            <div class="min-w-0 flex-1 space-y-8">
                ...
                <div class="space-y-4">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Pago</h3>
                ...
                <div>
                    <label for="voucher" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Ingresa el código promocional </label>
