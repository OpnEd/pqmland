<div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div x-data="{ open: false, message: '' }"
            ...
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Contáctanos
            </h2>
            <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Tienes preguntas sobre
                nuestros productos o servicios? Envíanos un mensaje y te responderemos lo más pronto posible.
            </p>
            <form wire:submit.prevent="save" class="space-y-8">
                <div>
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('messages.contact.name') }}</label>
                ...
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('messages.contact.email') }}</label>
                ...
                <div>
                    <label for="subject"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('messages.contact.subject') }}</label>
                ...
                <div class="sm:col-span-2">
                    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">{{ __('messages.contact.message') }}</label>
