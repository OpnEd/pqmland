...
<div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
    ...
    <div class="h-56 w-full">
        <a href="#">
            <img class="mx-auto h-full" src="{{ asset('storage/images/tienda/' . $categoria . '/' . $imagenes[0] . '.png') }}"
                alt="{{ $product->name }}" />
        </a>
    </div>
    <div class="pt-6">
        <div class="mb-4 flex items-center justify-between gap-4">
            ...
            <div class="flex items-center justify-end gap-1">
                <a href="{{ route('articulo.show', $product) }}" type="button" data-tooltip-target="tooltip-quick-look" target="__blank"
                    class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                    <span class="sr-only"> Echar un vistazo </span>
